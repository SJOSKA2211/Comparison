...
class TestCrankNicolson:
    ...
    def test_accuracy_vs_analytical_call(self):
        ...
        fdm = crank_nicolson_price(SPOT, STRIKE, RATE, VOLATILITY, TIME, "call", grid_size=200)
    ...
    def test_accuracy_vs_analytical_put(self):
        ...
        fdm = crank_nicolson_price(SPOT, STRIKE, RATE, VOLATILITY, TIME, "put", grid_size=200)
    ...
    def test_grid_convergence(self):
        ...
        coarse = crank_nicolson_price(SPOT, STRIKE, RATE, VOLATILITY, TIME, "call", grid_size=50)
        fine = crank_nicolson_price(SPOT, STRIKE, RATE, VOLATILITY, TIME, "call", grid_size=200)
